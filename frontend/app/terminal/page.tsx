...
export default function TerminalPage() {
  ...
  useEffect(() => {
    const logs = [
      '[SYSTEM] zobeide-terminal v1.0.0',
      '[SYSTEM] Connected to Base Sepolia Network',
  ...
  const topPersonalities = personalities ? personalities.slice(0, 4) : [];
            ...
            <Stack gap="md">
              <Group justify="space-between">
                <Group gap="xs">
                  ...
                  <Text size="xs" className="terminal-text">zobeide-terminal</Text>
                </Group>
